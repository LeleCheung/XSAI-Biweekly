...
本目录保存 XSAI 双周报的调研、审计和草稿。在负责人确认中英文稿之前，不修改 `../XiangShan-doc/`。
...
- [`reference/history/`](reference/history/): Biweekly 100-108 的 XSAI 摘录、分类、仓库和贡献者参考。
- [`reference/writing/`](reference/writing/): 写作笔记和常规供稿工作流。
- [`meta/`](meta/): 本次任务的背景记录。
